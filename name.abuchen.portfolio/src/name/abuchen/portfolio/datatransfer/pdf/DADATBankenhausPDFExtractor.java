...
public class DADATBankenhausPDFExtractor extends AbstractPDFExtractor
{
    public DADATBankenhausPDFExtractor(Client client)
    {
        ...
        addDividendAccountStatementTransaction();
        ...
        addTransferAccountStatementTransaction();
    ...
    {
        final var type = new DocumentType("(Abrechnungsauskunft|Kauf Depot)");
        this.addDocumentTyp(type);

        var pdfTransaction = new Transaction<BuySellEntry>();

        var firstRelevantLine = new Block("^(Gesch.ftsart: Kauf|Buchungsbestätigung)$");
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^Zu (Lasten|Gunsten) .* (\\-)?(?<amount>[\\-\\.,\\d]+) (?<currency>[A-Z]{3}).*$") //
                                                        .assign((t, v) -> {
                                        ...
                                        section -> section //
                                                        .attributes("currency", "amount") //
                                                        .match("^Betrag in (?<currency>[A-Z]{3}) (\\-)?(?<amount>[\\.,\\d]+).*$") //
                                                        .assign((t, v) -> {
                                                            t.setCurrencyCode(asCurrencyCode(v.get("currency")));
                                                            t.setAmount(asAmount(v.get("amount")));
                                                        }))
    ...
    private void addDividendTransaction()
    {
        ...
        var firstRelevantLine = new Block("^Abrechnung Ereignis$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .match("^Titel: (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9])[\\s]{1,}(?<name>.*)$") //
                        .match("^(?<name1>.*)$") //
                        .match("^Dividende: [\\.,\\d]+ (?<currency>[A-Z]{3}).*$") //
                        .assign((t, v) -> {
                            if (!v.get("name1").startsWith("Kurs:"))
                                v.put("name", trim(v.get("name")) + " " + trim(v.get("name1")));
    ...
    private void addBuySellAccountStatementTransaction()
    {
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} (Kauf|Kauf aus Dauerauftrag|Verkauf) .*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        ...
                                                        .documentContext("year") //
                                                        .match("^(?<date>[\\d]{1,2}\\.[\\d]{1,2}) (Kauf|Kauf aus Dauerauftrag|Verkauf)[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} [\\.,\\d]+(\\-)?$") //
                                                        .match("^ISIN (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9]) (?<name>.*)[\\s]{1,}(?<shares>[\\.,\\d]+) [A-Z]{3}$") //
                                                        .match("^(?i).* KURSWERT[\\s]{1,}(\\-)?[\\.,\\d]+ (?<currency>[A-Z]{3})$") //
                                                        .assign((t, v) -> {
                                                            v.put("name", replaceMultipleBlanks(v.get("name")));
                                                            t.setDate(asDate(v.get("date") + "." + v.get("year")));
                        ...
                        .match("^(?i).* KURSWERT[\\s]{1,}(\\-)?(?<fxGross>[\\.,\\d]+) (?<termCurrency>[A-Z]{3})$") //
    ...
    private void addDividendAccountStatementTransaction()
    {
        final var type = new DocumentType("KONTOAUSZUG", //
                        documentContext -> documentContext //
                                        // @formatter:off
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} Ertrag .*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^(?i)ISIN (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9]) (?<name>.*)[\\s]{1,}(?<shares>[\\.,\\d]+) STK$") //
                                                        .match("^(?i).* ZINSERTRAG[\\s]{1,}(\\-)?[\\.,\\d]+ (?<currency>[A-Z]{3})$") //
                                                        .assign((t, v) -> {
                                                            v.put("name", replaceMultipleBlanks(v.get("name")));
                                        ...
                                        section -> section //
                                                        .attributes("date", "isin", "name", "shares", "currency") //
                                                        .documentContext("year") //
                                                        .match("^(?i)(?<date>[\\d]{1,2}\\.[\\d]{1,2}) Ertrag[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} [\\.,\\d]+(\\-)?$") //
                                                        .match("^(?i)ISIN (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9]) (?<name>.*)[\\s]{1,}(?<shares>[\\.,\\d]+) STK$") //
                        ...
                        .optionalOneOf(
                                        ...
                                        section -> section
                                                        ...
                                                        .match("^(?i).* ZINSERTRAG[\\s]{1,}(\\-)?(?<fxGross>[\\.,\\d]+) (?<termCurrency>[A-Z]{3})$") //
                                                        .match("^(?i).*DevKurs[\\s]{1,}(?<exchangeRate>[\\.,\\d]+)\\/.*$") //
                                                        .assign((t, v) -> {
                                                            var rate = asExchangeRate(v);
                                                            type.getCurrentContext().putType(rate);
                                        ...
                                        section -> section
                                                        .attributes("fxGross", "termCurrency", "exchangeRate")
                                                        .match("^(?i).* Zinsen\\/Dividenden[\\s]{1,}(\\-)?(?<fxGross>[\\.,\\d]+) (?<termCurrency>[A-Z]{3})$") //
                                                        .match("^(?i).*DevKurs[\\s]{1,}(?<exchangeRate>[\\.,\\d]+)\\/.*$") //
                                                        .assign((t, v) -> {
                                                            var rate = asExchangeRate(v);
                                                            type.getCurrentContext().putType(rate);
    ...
    private void addDividendTaxesAccountStatementTransaction()
    {
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} (Steuern aussch.ttungsgl. Ertr.ge|Steuerdividende) .*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .oneOf( //
                                        ...
                                        // @formatter:on
                                        section -> section //
                                                        .attributes("date", "year", "isin", "name", "shares", "currency") //
                                                        .match("^(?i)(?<date>[\\d]{1,2}\\.[\\d]{1,2}) (Steuern aussch.ttungsgl. Ertr.ge|Steuerdividende)[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/(?<year>[\\d]{4})[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} [\\.,\\d]+(\\-)?$")
                                                        .match("^(?i)ISIN (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9]) (?<name>.*)[\\s]{1,}(?<shares>[\\.,\\d]+) STK$")
                                                        .match("^(?i).*KEST[\\s]{1,}\\-[\\.,\\d]+ (?<currency>[A-Z]{3})$")
                                                        .assign((t, v) -> {
                                                            v.put("name", replaceMultipleBlanks(v.get("name")));
                                                            t.setDateTime(asDate(v.get("date") + "." + v.get("year")));
                                                            t.setShares(asShares(v.get("shares")));
                                        ...
                                        section -> section //
                                                        ...
                                                        .match("^(?i)(?<date>[\\d]{1,2}\\.[\\d]{1,2}) (Steuern aussch.ttungsgl. Ertr.ge|Steuerdividende)[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/(?<year>[\\d]{4})[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} [\\.,\\d]+(\\-)?$")
                                                        .match("^(?i)ISIN (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9]) (?<name>.*)[\\s]{1,}(?<shares>[\\.,\\d]+) STK$")
                                                        .match("^(?i).*Kapitalertragsteuer[\\s]{1,}\\-[\\.,\\d]+ (?<currency>[A-Z]{3})$")
                                                        .assign((t, v) -> {
                                                            v.put("name", replaceMultipleBlanks(v.get("name")));
                                                            t.setDateTime(asDate(v.get("date") + "." + v.get("year")));
                                                            t.setShares(asShares(v.get("shares")));
                        ...
                        .section("amount") //
                        .documentContext("currency") //
                        .match("^(?i)[\\d]{1,2}\\.[\\d]{1,2} (Steuern aussch.ttungsgl. Ertr.ge|Steuerdividende)[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/[\\d]{4}[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} (?<amount>[\\.,\\d]+)(\\-)?$")
                        .assign((t, v) -> {
                            t.setCurrencyCode(v.get("currency"));
                            t.setAmount(asAmount(v.get("amount")));
                        })
                        ...
                        .match("^(?i).*(KEST|Kapitalertragsteuer)[\\s]{1,}\\-[\\.,\\d]+ (?<termCurrency>[A-Z]{3})$") //
                        .match("^(?i).*DevKurs[\\s]{1,}(?<exchangeRate>[\\.,\\d]+)\\/.*$") //
                        .assign((t, v) -> {
                            var rate = asExchangeRate(v);
                            type.getCurrentContext().putType(rate);
    ...
    private void addTaxLossAdjustmentAccountStatementTransaction()
    {
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} KESt\\-Verlustausgleich .*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .documentContext("year") //
                        .match("^(?i)(?<date>[\\d]{1,2}\\.[\\d]{1,2}) (?<note>KESt\\-Verlustausgleich)[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} [\\.,\\d]+(\\-)?$") //
                        .match("^(?i)ISIN (?<isin>[A-Z]{2}[A-Z0-9]{9}[0-9]) (?<name>.*)$") //
                        .match("^(?i).*(KEST|Kapitalertragsteuer)[\\s]{1,}[\\.,\\d]+ (?<currency>[A-Z]{3})$") //
                        .assign((t, v) -> {
                            v.put("name", replaceMultipleBlanks(v.get("name")));
                            t.setDateTime(asDate(v.get("date") + "." + v.get("year")));
                            t.setShares(0L);
                        ...
                        .section("amount") //
                        .documentContext("currency") //
                        .match("^(?i)[\\d]{1,2}\\.[\\d]{1,2} KESt\\-Verlustausgleich[\\s]{1,}Depot[\\s]{1,}[\\d]+\\/[\\d]{4}[\\d]+\\-[\\d]+ [\\d]{1,2}\\.[\\d]{1,2} (?<amount>[\\.,\\d]+)(\\-)?$") //
                        .assign((t, v) -> {
                            t.setCurrencyCode(v.get("currency"));
                            t.setAmount(asAmount(v.get("amount")));
                        })
    ...
    private void addInterestAccountStatementTransaction()
    {
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} Abschluss .*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
    ...
    private void addFeesAccountStatementTransaction()
    {
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} (Abschluss|Depotgeb.hrenabrechnung) .*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        .optionalOneOf( //
                                        ...
                                        section -> section //
                                                        .attributes("date", "note", "amount") //
                                                        .documentContext("year", "currency") //
                                                        .match("^(?i)(?<date>[\\d]{1,2}\\.[\\d]{1,2}) (?<note>IBAN: .*) [\\d]{1,2}\\.[\\d]{1,2} (?<amount>[\\.,\\d]+)\\-$") //
                                                        .assign((t, v) -> {
                                                            // @formatter:off
                                                            // Change from DEPOSIT to REMOVAL
                                                            // @formatter:on
    ...
    private void addTransferAccountStatementTransaction()
    {
        final var type = new DocumentType("KONTOAUSZUG", //
                        documentContext -> documentContext //
                                        // @formatter:off
        ...
        var firstRelevantLine = new Block("^[\\d]{1,2}\\.[\\d]{1,2} UMBUCHUNG.*$");
        type.addBlock(firstRelevantLine);
        firstRelevantLine.set(pdfTransaction);
        ...
        pdfTransaction //
                        ...
                        // 15.11 UMBUCHUNG   INTERNET AM 2021-11-15 15.11 2.500,00-
                        // @formatter:on
                        .section("date", "amount").optional() //
                        .documentContext("year", "currency") //
                        .match("^(?<date>[\\d]{1,2}\\.[\\d]{1,2}) UMBUCHUNG.* [\\d]{1,2}\\.[\\d]{1,2} (?<amount>[\\.,\\d]+)(\\-)?$") //
                        .assign((t, v) -> {
                            t.setDate(asDate(v.get("date") + "." + v.get("year")));
                            t.setCurrencyCode(v.get("currency"));
                            t.setAmount(asAmount(v.get("amount")));
    ...
    private <T extends Transaction<?>> void addTaxesSectionsTransaction(T transaction, DocumentType type)
    {
        transaction //
                        ...
                        .match("^(?i).*QUELLENSTEUER:[\\s]{1,}\\-(?<withHoldingTax>[\\-\\.,\\d]+) (?<currency>[A-Z]{3}).*$") //
                        ...
                        .match("^(?i).*Auslands\\-KESt:[\\s]{1,}\\-(?<tax>[\\-\\.,\\d]+) (?<currency>[A-Z]{3}).*$") //
    ...
    private <T extends Transaction<?>> void addFeesSectionsTransaction(T transaction, DocumentType type)
    {
        transaction //
                        ...
                        .match("^.*  DADAT Handelsspesen ([\\s]+)?\\-(?<fee>[\\.,\\d]+) (?<currency>[A-Z]{3}).*$") //
                        ...
                        // @formatter:on
                        .section("fee", "currency").optional() //
                        .match("^.*  Handelsspesen ([\\s]+)?\\-(?<fee>[\\-\\.,\\d]+) (?<currency>[A-Z]{3}).*$") //
                        .assign((t, v) -> processFeeEntries(t, v, type))
                        ...
                        // @formatter:on
                        .section("fee", "currency").optional() //
                        .match("^Clearing Geb.hr ([\\s]+)?\\-(?<fee>[\\-\\.,\\d]+) (?<currency>[A-Z]{3}).*$") //
                        .assign((t, v) -> processFeeEntries(t, v, type))
